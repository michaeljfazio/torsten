...
pub enum DelegationChange {
    ...
    Register {
        ...
        is_script: bool,
        pointer: Option<torsten_primitives::credentials::Pointer>,
    },
...
impl LedgerSeq {
    ...
    pub fn tip_point(&self) -> Point {
        if let Some(d) = self.deltas.back() {
            ...
            torsten_primitives::block::Point::Specific(d.slot, d.hash)
        } else {
    ...
    pub fn advance_anchor(&mut self) {
        ...
        self.anchor_point = torsten_primitives::block::Point::Specific(oldest.slot, oldest.hash);
...
pub fn apply_delta_to_state(state: &mut LedgerState, delta: &LedgerDelta) {
    ...
    state.tip = torsten_primitives::block::Tip {
        point: torsten_primitives::block::Point::Specific(delta.slot, delta.hash),
...
mod tests {
    ...
    fn test_push_beyond_k_advances_anchor() {
        ...
        assert!(matches!(
            seq.anchor_point(),
            torsten_primitives::block::Point::Specific(_, _)
        ));
    }
