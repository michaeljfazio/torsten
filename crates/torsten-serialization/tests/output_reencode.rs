...
use torsten_serialization::{decode_transaction, encode_transaction_output};
...
fn lsm_round_trip(
    ...
    let restored: torsten_primitives::transaction::TransactionOutput =
...
fn test_indef_array_encoding_difference_documented() {
    use torsten_primitives::transaction::PlutusData;
    use torsten_serialization::encode_plutus_data;
