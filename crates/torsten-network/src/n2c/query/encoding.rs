...
fn encode_pool_state(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    pool_params: &[crate::query_handler::PoolParamsSnapshot],
    future_pool_params: &[crate::query_handler::PoolParamsSnapshot],
    retiring: &[(Vec<u8>, u64)],
    deposits: &[(Vec<u8>, u64)],
) {
...
fn encode_pool_distr2(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    pools: &[crate::query_handler::StakePoolSnapshot],
...
fn encode_stake_address_info(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    addrs: &[crate::query_handler::StakeAddressSnapshot],
) {
...
fn encode_stake_snapshots(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    snapshots: &crate::query_handler::StakeSnapshotsResult,
) {
...
fn encode_drep_stake_distr(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    entries: &[crate::query_handler::DRepStakeEntry],
) {
...
fn encode_filtered_vote_delegatees(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    delegatees: &[crate::query_handler::VoteDelegateeEntry],
) {
...
fn encode_drep_state(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    dreps: &[crate::query_handler::DRepSnapshot],
) {
...
fn encode_committee_state(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    committee: &crate::query_handler::CommitteeSnapshot,
) {
...
fn encode_debug_new_epoch_state(
    ...
    snap_fee: u64,
    total_active_stake: u64,
    pool_distr: &[crate::query_handler::StakePoolSnapshot],
) {
...
fn encode_reward_info_pools(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    pools: &[crate::query_handler::PoolRewardInfo],
) {
...
fn encode_era_history(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    summaries: &[crate::query_handler::EraSummary],
) {
...
fn encode_ledger_peer_snapshot(
    enc: &mut minicbor::Encoder<&mut Vec<u8>>,
    peers: &[crate::query_handler::LedgerPeerEntry],
) {
