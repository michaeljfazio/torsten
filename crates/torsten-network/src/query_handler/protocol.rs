...
// ---------------------------------------------------------------------------
// Exact rational arithmetic (mirrors the Rat struct in torsten-ledger rewards)
// ---------------------------------------------------------------------------

/// Arbitrary-precision rational for exact non-myopic reward calculations.
///
/// Mirrors `torsten_ledger::state::rewards::Rat` so that this crate does not
/// need to depend on torsten-ledger.  All BigInt arithmetic eliminates any
