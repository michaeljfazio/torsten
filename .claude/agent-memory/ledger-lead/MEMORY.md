...
- [issue-186-plutus-test-coverage.md](issue-186-plutus-test-coverage.md) — Tests added for is_valid=false full UTxO behaviour, treasury Phase-1 check, per-redeemer V3 Unit check. Also fixed: `redeemer_script_version_map` in collateral.rs was missing (working tree broken).
